...
/// Task 03: every rendered `Text`/`RichText` in Pocket Biome must resolve
/// to one of the two bundled font families — never a platform default.
///
...
const _bundledFamilies = {
  PocketBiomeTypography.displayFamily,
  PocketBiomeTypography.bodyFamily,
};
