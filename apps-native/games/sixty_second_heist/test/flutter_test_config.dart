...
/// instead of tofu/fallback boxes (task 03).
///
...
const Map<String, List<String>> _bundledFonts = {
  'Bungee': ['assets/fonts/Bungee/Bungee-Regular.ttf'],
  'ChakraPetch': [
    'assets/fonts/ChakraPetch/ChakraPetch-Regular.ttf',
    'assets/fonts/ChakraPetch/ChakraPetch-Medium.ttf',
    'assets/fonts/ChakraPetch/ChakraPetch-SemiBold.ttf',
    'assets/fonts/ChakraPetch/ChakraPetch-Bold.ttf',
  ],
};
