...
/// instead of tofu/fallback boxes (task 07).
///
...
const Map<String, List<String>> _bundledFonts = {
  'Fredoka': ['assets/fonts/Fredoka/Fredoka[wdth,wght].ttf'],
  'NunitoSans': [
    'assets/fonts/NunitoSans/NunitoSans[YTLC,opsz,wdth,wght].ttf',
    'assets/fonts/NunitoSans/NunitoSans-Italic[YTLC,opsz,wdth,wght].ttf',
  ],
};
